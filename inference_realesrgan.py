...
def main():
    ...
    upsampler = RealESRGANer(
        ...
        half=args.half)
    _, _, files_inputs = next(os.walk(r"data\input_chips"))
    file_count_inputs = len(files_inputs)
    ...
    print("Testing process has begun:")
    with tqdm(total=file_count_inputs) as pbar:

        for idx, path in enumerate(paths):
            imgname, extension = os.path.splitext(os.path.basename(path))
            print('Enhancing', idx, ',', imgname)
